                    ...
                    <div class="card" style="width: 18rem;">
                        <a href="admin/room/detail/{{$r->id}}">
                            ...
                            <div class="card-body">
                                ...
                                @else
                                <a onclick="return confirm('Việc thay đổi trạn thái phòng đồng nghĩa với việc thay đổi trạng thái sinh viên')" href="admin/room/on/{{$r->id}}" style="margin-bottom: 10px;" class="btn btn-sm btn-success" title="Khoá">Bật</a>
                                @endif
                                <a href="admin/room/destroy/{{$r->id}}" onclick="return confirm('Bạn có chắc chắn xóa? hãy đảm bảo chuyển phòng cho sinh viên trước khi thực hiện')" style="margin-bottom: 10px;" class="btn btn-danger btn-sm">Xóa phòng</a>
                            </div>
                        </div>
                    </div>
                @endforeach
