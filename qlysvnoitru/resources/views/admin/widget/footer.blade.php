    ...
    <script src="admin_asset/tinymce/jquery.tinymce.min.js" type="text/javascript"></script>
    <script src="admin_asset/tinymce/tinymce.min.js" type="text/javascript"></script>
    <script src="admin_asset/js/jquery.validate.min.js" type="text/javascript"></script>
    <script src="admin_asset/js/typeahead.bundle.min.js" type="text/javascript"></script>
